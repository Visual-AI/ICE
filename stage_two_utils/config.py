...
def parse_args(input_args=None):
    ...
    parser.add_argument("--step1_train_steps", type=int, default="400", help="Number of trainig steps for the first and second phases concept learning.",)
    parser.add_argument("--step2_train_steps", type=int, default="400", help="Number of trainig steps for the concept refinement.",)
    ...
    # config added for ICE
    parser.add_argument("--noise_offset", type=float, default=0.1, help="https://www.crosslabs.org//blog/diffusion-with-offset-noise")
    parser.add_argument("--t_dist", type=float, default=0.5, help="Temperature for the weighted timestep based on ReVersion",)
    parser.add_argument("--inspec_token", type=str, default="<*>", help="A token to use as a instance-specific placeholder for the concept.",)
    parser.add_argument("--conspec_token", type=str, default="<&>", help="A token to use as a concept-specific placeholder for the concept.",)
    ...
    parser.add_argument("--reg_intrinsic_weight", type=float, default=5e-2)
    parser.add_argument("--pos_neg_margin", type=float, default=5e-2)
    parser.add_argument("--intrinsic_anchors", type=str, nargs="+", default=["color", "material"])
    ...
    args.max_train_steps = args.step1_train_steps + args.step2_train_steps
